private ["_botActive","_doLoop","_hiveVer","_isHiveOk","_playerID","_playerObj","_randomSpot","_primary","_key","_charID","_playerName","_items","_magazines","_weapons","_backpack","_worldspace","_direction","_newUnit","_isNew","_inventory","_survival","_state","_model","_config","_mags","_wpns","_bcpk","_medicalStats","_tent","_newPlayer","_secondary","_dmodel","_result"];
//Set Variables
...
//	_secondary = _key call server_hiveReadWrite;
//};
//_dmodel = _secondary select 0;

while {((_secondary select 0) == "CustomStreamStart")} do {
_secondary = _key call server_hiveReadWrite;
};
_dmodel = _secondary select 0;
...
PVCDZ_plr_Login = [_charID,_inventory,_backpack,_survival,_isNew,dayz_versionNo,_model,_isHiveOk,_newPlayer,_dmodel];
