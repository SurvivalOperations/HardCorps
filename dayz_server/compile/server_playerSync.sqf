...
if (_characterID != "0") then {
	...
	if (_characterID != "0") then {		
		...
		*/
		...
		} forEach nearestObjects [_pos, ["Car", "Helicopter", "Motorcycle", "Ship", "TentStorage", "StashSmall","StashMedium","Mine","BAF_ied_v1","pook_camonet_small_west_drop3","pook_camonet_small_west_drop15","pook_camonet_med_west_drop19"], 10];
