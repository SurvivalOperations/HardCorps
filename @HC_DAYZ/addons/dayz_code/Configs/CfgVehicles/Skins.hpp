...
class Soldier1_DZ: GUE_Soldier_MG {
	displayName = "Soldier";
	side = 1;
	weapons[] = {"Throw","Put"};
	backpack = "";
...
//-----------------------------------------//
//    S U R V I V A L  O P S  S K I N S    //
//-----------------------------------------//

class FR_TL;
class SO_Officer_DZ: FR_TL {
	displayName = "Survival Operations Officer";
	side = 1;
	weapons[] = {"Throw","Put"};
	canCarryBackPack = 1;
	backpack = "";
