...
if (!isDedicated) then {
	...
	local_gutObjectH = compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\local_gutObjectH.sqf";	//Generated on the server (or local to unit) when gutting an object
