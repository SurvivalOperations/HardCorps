...
// ---- SETTINGS
BTK_Gasmask_Damage = 0.4;           // - How many damage from conterminated air? (in %)
...
BTK_Gasmask_Area1Radius = 500;       // - Radiation area around the object (in meter)
